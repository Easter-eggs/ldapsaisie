...
/*
 ***************************************************
 * DonnÃ©es de configuration pour le support SUPANN *
 ***************************************************
 */
...
// DN de l'entite SUPANN correspondant Ã  l'etablissement
 ...
 *
 * Tableau stockant les nomenclautures utilisÃ©es.
 *
 * Doc SUPANN :
 ...
 * );
 *
 * [ETIQUETTE] : l'Ã©tiquette de la valeur
 * [table] : le nom de la table :
 *   - roleGenerique : les rÃ´les gÃ©nÃ©riques
 *   - typeEntite : les types d'entitÃ©s
 *   - empCorps : les corps d'appartenances des personnels
 *   - codeEtablissement : les codes d'Ã©tablissement
 *   - etuRegimeInscription : les rÃ©gimes d'inscription Ã©tudiant
 *   - etuSecteurDisciplinaire : les secteurs disciplinaires de dÃ®plomes ou d'enseignements
 *   - etuTypeDiplome : les types de diplÃ´me
 *   - etuDiplome : les diplÃ´mes
 *   - etuEtape : les Ã©tapes des enseignements
 *   - etuElementPedagogique : les Ã©lÃ©ments pÃ©dagogiques
 *
 */
$GLOBALS['supannNomenclatures'] = array (
	'SUPANN' => array (
		'roleGenerique' => array (
			...
			"J62" => "Directeur des Ã©tudes adjoint",
			...
			"P51" => "SecrÃ©taire GÃ©nÃ©ral adjoint",
			...
			"T80" => "MaÃ®trise d'ouvrage des SI",
			"T81" => "MaÃ®trise' d'Å“uvre des SI",
			"T82" => "AQSSI",
			"T83" => "RSSI",
			"T84" => "CSSI (Correspondant/ChargÃ© de SSI)",
			"X00" => "MEDIATEUR",
			"X01" => "MEDECIN",
			...
			"X70" => "ACMO H&S",
			"X71" => "ChargÃ© de service de prÃ©vention H&S",
			"X80" => "Assesseur"
		),
		'typeEntite' => array (
			"C000" => "Bureau du prÃ©sident",
			"C010" => "Groupement d'IntÃ©rÃªt Scientifique (GIS)",
			"C020" => "Aide Ã  la conception de produits pÃ©dagogiques",
			"C021" => "Conception de dispositifs de formation ouverts et Ã  distance",
			"C022" => "Coordination d'enseignement transversaux Ã  plusieurs diplÃ´mes",
			"C023" => "CrÃ©ation et mise en place d'une nouvelle filiÃ¨re",
			"C030" => "Haut comitÃ© Ã©ducation Ã©conomie",
			"C031" => "Organisation",
			"C032" => "Participation au dÃ©veloppement et Ã  l'animation de formations dÃ©localisÃ©es",
			"C033" => "Participation aux activitÃ©s de formation continue",
			...
			"E301" => "ComitÃ© HygiÃ¨ne et SÃ©curitÃ©",
			"E302" => "ComitÃ© de Pilotage SGI",
			"E303" => "ComitÃ© Technique Paritaire ",
			"E304" => "ComitÃ© consultatif",
			"E305" => "ComitÃ© de sÃ©lection",
			"E306" => "ComitÃ© de Pilotage SGI",
			"E401" => "Jury",
			"E801" => "Conseil CROUS",
			"E901" => "CNESER (Conseil National de l'Ens. Sup. Rech.)",
			"E902" => "CNU Conseil National des UniversitÃ©s",
			"E903" => "CTPM ComitÃ© Tech. Par. Min. Ens. Sup. Rech.",
			"S101" => "Grand Ã©tablissement",
			"S102" => "UniversitÃ©",
			"S103" => "Institut ",
			"S104" => "Ã‰cole ",
			"S105" => "ENS (Ecole Normale SupÃ©rieure)",
			"S106" => "PRES   (si celui-ci est de type EPSCP) sinon il faudra une catÃ©gorie N1-Autre",
			"S107" => "EFE (Ecole FranÃ§aise de l'Etranger)",
			"S108" => "Ã‰tablissement public administratif rattachÃ©",
			"S109" => "Observatoire   est-ce un EPSCP? Si oui il faut mettre N1-Ã©tablissement",
			"S120" => "PÃ´le ",
			"S200" => "Composante",
			"S201" => "UFR",
			"S202" => "DÃ©partement",
			"S203" => "UnitÃ© de recherche",
			"S204" => "Institut ",
			"S205" => "Ã‰cole",
			"S206" => "Centre polytechnique universitaire",
			"S207" => "OSU (Observatoire des Sciences de l'Univers)",
			"S208" => "IUFM",
			"S220" => "Structure fÃ©dÃ©rative de recherche",
			"S221" => "CollÃ¨ge des Ã©coles doctorales",
			"S222" => "Ã‰cole doctorale",
			"S230" => "Service central",
			"S231" => "Service gÃ©nÃ©ral ",
			"S233" => "ScolaritÃ©",
			...
			"S253" => "SCUIO",
			"S254" => "SAIC",
			"S255" => "Autres comme CEP, UEFAPS, â€¦",
			"S256" => "Service technique",
			"S257" => "CatÃ©gorie prÃ©vue dans la loi / peut Ãªtre appelÃ© \"service-commun-rattachÃ©\"",
			"S300" => "Cabinet",
			"S301" => "Coordination",
			"S302" => "Division",
			"S304" => "Mission",
			"S310" => "Laboratoire",
			"S311" => "DÃ©partement de formation",
	...
	'UAI' => array (
		'codeEtablissement' => array (
			...
			"0130239P" => "Ecole SupÃ©rieure de Commerce de Marseille du groupe EUROMED",
			"0132396J" => "ECOLE SUPERIEURE D'INGENIEURS DE MARSEILLE-CCIMP GROUPE ESIM IMT",
			"0133347T" => "Institut SupÃ©rieur de Micro-Electronique AppliquÃ©e Ecole Nationale SupÃ©rieure des Mines de St Etienne",
			"0130238N" => "Institut supÃ©rieur du BÃ¢timent et des Travaux Publics - CCIMP",
			...
			"0631833A" => "INSTITUT FRANÃ‡AIS DE MECANIQUE AVANCEE DE CLERMONT-FERRAND",
			...
			"0941934S" => "Ecole d'ingÃ©nieurs des technologies de l'information et du management",
			...
			"0930603A" => "institut supÃ©rieur de mÃ©canique de paris",
			...
			"0440112H" => "Audencia Ã©cole management Nantes",
			...
			"0851465F" => "Ecole de gestion et de commerce VendÃ©e",
			...
			"0831458J" => "Institut SupÃ©rieur d'Electronique et du Numerique - TOULON",
			...
			"0754431J" => "ECOLE CENTRALE D ÌELECTRONIQUE PARIS",
			...
			"0161122H" => "Ecole de gestion et de commerce d'AngoulÃ¨me",
			...
			"0101059X" => "Ecole SupÃ©rieure de Commerce",
			"0511935B" => "Institut Universitaire de Formation des MaÃ®tres de l'acadÃ©mie de Reims",
			"0510088U" => "Reims management school",
			"0511296G" => "UniversitÃ© de Reims",
			"0101060Y" => "UniversitÃ© de Technologie de Troyes",
			...
			"0290127F" => "Ecole SupÃ©rieure de Commerce de Bretagne Brest de la Chambre de Commerce et d'Industrie de Brest",
			...
			"0271338H" => "Ecole supÃ©rieure d'ingÃ©nieurs et techniciens pour l'agriculture",
			...
			"0670190T" => "Institut nationale des sciences appliquÃ©es de Strasbourg",
			...
			"0312020C" => "Centre d'Etudes SupÃ©rieures Industrielles Midi-PyrÃ©nÃ©es",
			"0811293R" => "Centre Universitaire de Formation et de Recherche du Nord-Est Midi-PyrÃ©nÃ©es Jean-Francois Champollion Albi",
			"0820822Y" => "Ecole de Gestion et de Commerce",
			"0310154Z" => "Ecole d'IngÃ©nieur de purpan",
			"0312069F" => "Ecole Nationale de la MÃ©tÃ©orologie",
			"0311256X" => "Ecole Nationale de l'Aviation Civile de Toulouse",
			"0650048Z" => "Ecole Nationale d'IngÃ©nieurs de Tarbes",
			"0811200P" => "Ecole Nationale SupÃ©rieure des Techniques Industrielles et des Mines d'Albi-Carmaux",
			"0121367W" => "Ecole supÃ©rieure technique privÃ©e de gestion commerce informatique",
			"0312013V" => "Ecole supÃ©rieure technique privÃ©e gestion commerce informatique",
			"0310156B" => "Groupe Ecole supÃ©rieure de Commerce",
			"0310155A" => "Institut catholique Toulouse",
			"0312421N" => "Institut Catholique d'arts et mÃ©tiers de Toulouse",
			"0310152X" => "Institut National des Sciences AppliquÃ©es de Toulouse",
			"0311381H" => "Institut National Polytechnique de Toulouse",
			"0312760G" => "Institut SupÃ©rieur de l'AÃ©ronautique et de l'Espace",
			"0312299F" => "Institut Universitaire de Formation des MaÃ®tres AcadÃ©mie de Toulouse Midi-PyrÃ©nÃ©es",
			"0311382J" => "UniversitÃ© Toulouse 1 Sciences Sociales",
			"0311383K" => "UniversitÃ© Toulouse 2 Le Mirail",
			"0311384L" => "UniversitÃ© Toulouse 3 Paul Sabatier",
			...
			"0922563L" => "Ecole SupÃ©rieure d'IngÃ©nieurs LÃ©onard De Vinci. Etablissement d'Enseignement SupÃ©rieur Technique PrivÃ©.",
			"0910725U" => "ECOLE SUPERIEURE D'OPTIQUE",
			"0922374F" => "ECOLE SUPERIEURE PRIVEE COMMERCE EXTERIEUR ESCE LDV",
			"0951804V" => "institut gÃ©ologique albert de lapparent (igal)",
			"0910685A" => "INSTITUT NATIONAL DES SCIENCES ET TECHNIQUES NUCLEAIRES",
			"0911781S" => "INSTITUT NATIONAL DES TELECOMMUNICATIONS",
			"0951808Z" => "institut supÃ©rieur des techniques d'outre-mer (istom)",
	...
	'SISE' => array (
		...
		'etuTypeDiplome' => array (
			...
			'FM' => "DIPLÃ”ME INGENIEUR CONJOINT",
			...
			'WB' => "DIPLÃ”ME ARCHITECTE DE L'INSA",
			'XA' => "LICENCE (LMD)",
			'XB' => "MASTER (LMD)",
			'XC' => "MASTER INGENIEUR",
